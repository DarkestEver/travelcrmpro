import { FiPlus, FiEdit, FiTrash2, FiClock, FiMapPin, FiDollarSign } from 'react-icons/fi';

const DayTimeline = ({ day, onAddComponent, onEditComponent, onDeleteComponent }) => {
  if (!day) {
    return (
  ...
  const renderComponentCard = (component, index) => {
    ...
    return (
      <div
        ...
        className="bg-white rounded-lg border-2 border-gray-200 p-4 hover:border-primary-300 hover:shadow-md transition-all group"
      >
        {/* Header */}
